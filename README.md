...
- MaxStyle layer with learnable paprameters for smart style pertubation: [MaxStyle/src/advanced/maxstyle.py](MaxStyle/src/advanced/maxstyle.py).
- An example of an image decoder with MaxStyle layers inserted [MaxStyle/src/models/ebm/encoder_decoder.py](MaxStyle/src/models/ebm/encoder_decoder.py), see MyDecoder.apply_max_style().
- Code for generating and optimizing style augmentation at training can be found at [MaxStyle/src/models/advanced_triplet_recon_segmentation_model.py](MaxStyle/src/models/advanced_triplet_recon_segmentation_model.py), see generate_max_style_image(). 
